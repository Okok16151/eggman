function onCreate()
	...
	makeAnimatedLuaSprite('sonic', 'sonic', 1520, 280)
	scaleObject('dorkly', 8, 8);
	addAnimationByPrefix('sonic', 'sonic idle', 'sonic idle', 10, true)
	objectPlayAnimation('sonic', 'sonic idle', true)
	
	makeLuaSprite('zzzz', 'zzzz', 0, 0)
	scaleObject('zzzz', 8, 8)
	setLuaSpriteScrollFactor('zzzz', 0.2, 0.2);
	...
	addLuaSprite('zzzz', false)
	setProperty('zzzz.antialiasing',false)
end
